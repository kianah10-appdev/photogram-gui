class PhotosController < ApplicationController
  ...
  def update
    #Parameters: {"query_image"=>"https://www.chicagobooth.edu/-/media/project/chicago-booth/mbalife/full-time/2020/profile-header.jpg?cx=0.42&cy=0.43&cw=940&ch=749&hash=84736E80349AE484E2F16941CF6B6AF9", "query_caption"=>"juj", "modify_id"=>"951"}
